...
public class JHipsterProperties {
	...
	public static class Mail {
		...
		private String from = "saturnsecsys@gmail.com";
	...
	public static class Swagger {
		...
		private String title = "saturn API";

		private String description = "saturn API documentation";
